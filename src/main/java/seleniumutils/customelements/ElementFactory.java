...
public class ElementFactory {
	...
	/* Initializes a page factory from a class with a template of LogElements. */
	/*
	 * public static <T> T initElements(WebDriver driver, Class<T> pageClassToProxy)
	 * { try { T page =
	 * pageClassToProxy.getConstructor(WebDriver.class).newInstance(driver);
	 * PageFactory.initElements(new ElementDecorator(new
	 * DefaultElementLocatorFactory(driver)), page); // ElementDecorator we've
	 * modified return page; } catch (InstantiationException |
